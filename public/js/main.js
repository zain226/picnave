  ...
  jQuery(document).ready(function ($) {
    $(window).scroll(function () {
      if ($(window).scrollTop() >= 100) {
        ...
        $('.navbar a').attr('style', 'color: #191b26');
        // $('.navbar a:active').attr('style', 'color: #ffff');
      } else {
        $('#header').attr('style', 'background: transparent;');
        $('.navbar a').attr('style', 'color: #fff');
        $('.navbar a.active').attr('style', 'color: #191b26');
      }
    });
    $('.owl-carousel.cat-slider').owlCarousel({
      nav: true,
      loop: true,
      margin: 10,
