                ...
                <div class="">
                    <div class="">
                        <div class="">
                            ...
                            <form class="new_user" id="new_user" action="/sign-up/" accept-charset="UTF-8"
                                  method="post"><input type="hidden" name="authenticity_token"
                                                       value="XIyJ000GpNKGlMgNu72P2YLzaZpHm8Ys000oWQxb1PsvX029EE8zVCemvZ5ZjbztM8WhikhYIGZHAE2AFDSdMg"
                                                       autocomplete="off">
                                <div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" required name="first_name" class="form-control" id="exampleFormControlInput1" placeholder="First Name">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" required name="last_name" class="form-control" id="exampleFormControlInput1" placeholder="Last Name">
                                            </div>
                                        </div>
